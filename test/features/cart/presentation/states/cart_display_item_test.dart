...
void main() {
  group('CartDisplayItem', () {
    ...
    test('calculates hasDiscount, totalPrice, totalOriginalPrice, totalSavings correctly with discount', () {
    ...
    test('calculates hasDiscount, totalPrice, totalOriginalPrice, totalSavings correctly without discount', () {
      const item = CartDisplayItem(
        cartItemId: '1_1_S',
        productId: '1',
        designId: '1',
